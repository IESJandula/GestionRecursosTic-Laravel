    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item active open">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{ route('mostrar.tipos.dispositivos') }}" class="menu-link">
                        <div data-i18n="eCommerce">Tipo de Equipo</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('listarAveriados') }}" class="menu-link">
                        <div data-i18n="Logistics">Dispositivos Dañados</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('asignar-ubicacion') }}" class="menu-link">
                        <div data-i18n="Academy">Asignar Ubicacion</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('ver-equipos-desechados') }}" class="menu-link">
        ...
        <li class="menu-item active open">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{ url('ubicaciones') }}" class="menu-link">
        ...
        <li class="menu-item active open">
            ...
            <ul class="menu-sub">
                <!--MENU PENDIENTE DE ENLAZAR!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
                <li class="menu-item">
                    <a href="{{ url('administradores') }}" class="menu-link">
